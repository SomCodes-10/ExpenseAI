    ...
    <div className="max-w-6xl mx-auto px-4 py-6 sm:px-6 sm:py-10 lg:px-10">
      ...
      <div className="mb-6 sm:mb-10 flex items-start justify-between gap-3">
        <div className="flex flex-col gap-2">
          ...
          <Pulse className="h-3.5 w-44 hidden sm:block" />
        </div>
        <div className="flex flex-col sm:flex-row items-end sm:items-center gap-2 shrink-0">
          <Pulse className="h-9 w-9 sm:w-36 rounded-xl" />
          <Pulse className="h-9 w-9 sm:w-36 rounded-xl" />
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 sm:px-6 sm:py-10 lg:px-10">
        ...
        <div className="mb-6 sm:mb-10">
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="hidden sm:flex items-center gap-2.5 shrink-0">
              ...
              <button
                ...
                className="group relative inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-violet-600 rounded-xl border border-violet-200 bg-white/70 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:-translate-y-0.5 hover:border-violet-400 hover:bg-violet-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-2"
                style={{ boxShadow: '0 1px 4px rgba(99,102,241,0.10), 0 1px 2px rgba(0,0,0,0.04)' }}
                aria-label="Go to AI Insights"
              >
                <span className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.06) 0%, transparent 60%)' }} />
                <svg className="w-4 h-4 relative z-10 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
          ...
          <div className="flex gap-2 mt-4 sm:hidden">
            ...
            <button
              onClick={() => navigate('/insights')}
              className="group relative flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold text-violet-600 rounded-xl border border-violet-200 bg-white/80 backdrop-blur-sm overflow-hidden transition-all duration-200 active:scale-95"
              style={{ boxShadow: '0 1px 4px rgba(99,102,241,0.10)' }}
              aria-label="Go to AI Insights"
            >
        ...
        {/* Stat Cards Grid */}
        <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-5">
